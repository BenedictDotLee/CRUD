<?php
    ...
    if($_POST){
        ...
        $sql = "UPDATE `register` SET `email`='$email',`password`='$password' WHERE id='$id'";
        // echo $sql;
        // exit;
        $result = mysqli_query($conn, $sql);
                ...
                <div class="col-md-4 col-md-offset-4">
                    <form method="POST">
                      <div class="form-group">
                        ...
                        <input type="id" name="id" value="<?php echo $row['id'] ?>" class="form-control" id="id" required/>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label>
                        <input type="email" name="email" value="<?php echo $row['email'] ?>" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Enter your email address" required/>
